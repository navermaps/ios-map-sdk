...
class PathOverlayViewController: MapViewController {
    ...
    override func viewDidLoad() {
        ...
        if let pathOverlayWithPattern = NMFPath(points: CoordsData.coords2) {
    ...
    @IBAction func respondToProgress(_ sender: UISlider) {
        progressPathOverlay?.progress = Double(sender.value)
 ...
 extension PathOverlayViewController: NMFMapViewTouchDelegate {
 ...
 struct CoordsData {
    static let coords1 = [NMGLatLng(lat: 37.5594084, lng: 126.9745830),
    ...
    static let coords2 = [NMGLatLng(lat: 37.5660645, lng: 126.9826732),
